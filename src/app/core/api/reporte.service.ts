...
import { MovimientoList } from '../models/entities.model';
...
export class ReporteService {
  ...
  kardex(productoId: number, desde: string, hasta: string, page = 0, size = 20): Observable<Page<MovimientoList>> {
    const params = new HttpParams()
      ...
      .set('page', page)
      .set('size', size);
    return this.http.get<Page<MovimientoList>>(`${this.base}/kardex`, { params });
  }
