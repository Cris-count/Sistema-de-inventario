...
@Component({
  ...
  template: `
    <div class="space-y-2">
      <h2 class="text-xl font-semibold tracking-tight text-slate-900 dark:text-slate-100">2. Datos de la empresa</h2>
      <p class="text-sm text-slate-600 dark:text-slate-400">Identificación única (NIT, RUC, etc.) y datos de contacto.</p>
    </div>

    <div class="mt-6 grid gap-4 sm:grid-cols-2">
      <label class="block sm:col-span-2">
        <span class="text-xs font-semibold uppercase tracking-wide text-slate-600 dark:text-slate-400">Nombre comercial</span>
        <input
      ...
      <label class="block">
        <span class="text-xs font-semibold uppercase tracking-wide text-slate-600 dark:text-slate-400">Identificación tributaria</span>
        <input
          class="mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 outline-none ring-teal-500/30 focus:ring-2 placeholder:text-slate-400 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100 dark:ring-teal-500/35 dark:placeholder:text-slate-500"
      ...
      <label class="block">
        <span class="text-xs font-semibold uppercase tracking-wide text-slate-600 dark:text-slate-400">Sector / tipo</span>
        <input
          class="mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 outline-none ring-teal-500/30 focus:ring-2 placeholder:text-slate-400 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100 dark:ring-teal-500/35 dark:placeholder:text-slate-500"
          [value]="value().sector"
      ...
      <label class="block sm:col-span-2">
        <span class="text-xs font-semibold uppercase tracking-wide text-slate-600 dark:text-slate-400">Correo de contacto</span>
        <input
          type="email"
          class="mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 outline-none ring-teal-500/30 focus:ring-2 placeholder:text-slate-400 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100 dark:ring-teal-500/35 dark:placeholder:text-slate-500"
      ...
      <label class="block">
        <span class="text-xs font-semibold uppercase tracking-wide text-slate-600 dark:text-slate-400">Teléfono</span>
        <input
          class="mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 outline-none ring-teal-500/30 focus:ring-2 placeholder:text-slate-400 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100 dark:ring-teal-500/35 dark:placeholder:text-slate-500"
      ...
      <label class="block">
        <span class="text-xs font-semibold uppercase tracking-wide text-slate-600 dark:text-slate-400">País</span>
        <input
          class="mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 outline-none ring-teal-500/30 focus:ring-2 placeholder:text-slate-400 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100 dark:ring-teal-500/35 dark:placeholder:text-slate-500"
          [value]="value().pais"
      ...
      <label class="block sm:col-span-2">
        <span class="text-xs font-semibold uppercase tracking-wide text-slate-600 dark:text-slate-400">Ciudad</span>
        <input
          class="mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 outline-none ring-teal-500/30 focus:ring-2 placeholder:text-slate-400 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100 dark:ring-teal-500/35 dark:placeholder:text-slate-500"
          [value]="value().ciudad"
